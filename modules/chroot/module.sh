...
export METASYSTEM_CHROOT_ROOT=$( builtin cd "$( dirname "${BASH_SOURCE:-$0}" )" && pwd )
export METASYSTEM_CHROOT_BIN=$METASYSTEM_CHROOT_ROOT/bin
...
PATH=$(path_append $METASYSTEM_CHROOT_BIN $PATH)
